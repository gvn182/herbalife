<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true"
    CodeBehind="FechamentoDiarioDetalhe.aspx.cs" Inherits="Front.FechamentoDiarioDetalhe" ClientIDMode="Static" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="assets/code/FechamentoDiario.js" type="text/javascript"></script>
    <div class="page-header">
        <h1>
            Relatorio <small><i class="icon-double-angle-right"></i>Fechamento diario detalhe</small>
        </h1>
    </div>
    <div class="col-xs-12">
        <div class="filtering">
