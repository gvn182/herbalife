        ...
        function TMForm() {
            ...
            function formSubmit() {
                ...
                if (!$('label.' + opt.invalidClass + ',label.' + opt.emptyClass, form).length) {
                    var Nome = getValue($('label.name input'));
                    var Email = getValue($('label.email input'));
                    var Mensagem = getValue($('label.message textarea'))
                   
                    PageMethods.SendMail(Nome, Email, Mensagem, OnSucessEmail, OnError);
